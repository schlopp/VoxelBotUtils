...
class AnalyticsLogHandler(logging.NullHandler):
    ...
    HTTP_EVENT_NAMES = {
        "GET": {
            ...
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})/reactions/(.+)$",
                re.IGNORECASE,
            ): "get_reaction_users",
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})$", re.IGNORECASE
            ): "get_message",
            re.compile(r"/guilds/([0-9]{15,23})/bans$", re.IGNORECASE): "get_bans",
            re.compile(
                r"/guilds/([0-9]{15,23})/bans/([0-9]{15,23})$", re.IGNORECASE
            ): "get_ban",
            re.compile(
                r"/guilds/([0-9]{15,23})/channels$", re.IGNORECASE
            ): "get_channels",
            re.compile(
                r"/guilds/([0-9]{15,23})/members$", re.IGNORECASE
            ): "get_members",
            re.compile(
                r"/guilds/([0-9]{15,23})/members/([0-9]{15,23})$", re.IGNORECASE
            ): "get_member",
            re.compile(
                r"/guilds/([0-9]{15,23})/emojis$", re.IGNORECASE
            ): "get_custom_emojis",
            re.compile(
                r"/guilds/([0-9]{15,23})/emojis/([0-9]{15,23})$", re.IGNORECASE
            ): "get_custom_emoji",
            re.compile(
                r"/guilds/([0-9]{15,23})/audit-logs$", re.IGNORECASE
            ): "get_audit_logs",
            re.compile(r"/guilds/([0-9]{15,23})/roles$", re.IGNORECASE): "get_roles",
        },
        "POST": {
            re.compile(
                r"/channels/([0-9]{15,23})/messages$", re.IGNORECASE
            ): "send_message",
            re.compile(
                r"/channels/([0-9]{15,23})/messages/bulk_delete$", re.IGNORECASE
            ): "bulk_delete",
            re.compile(
                r"/guilds/([0-9]{15,23})/channels$", re.IGNORECASE
            ): "create_channel",
            ...
            re.compile(
                r"/interactions/([0-9]{15,23})/([a-zA-Z0-9\-_]+?)/callback$",
                re.IGNORECASE,
            ): "create_interaction_response",
        },
        "PUT": {
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})/reactions/(.+?)/@me$",
                re.IGNORECASE,
            ): "add_reaction",
            re.compile(
                r"/guilds/([0-9]{15,23})/bans/([0-9]{15,23})$", re.IGNORECASE
            ...
            re.compile(
                r"/guilds/([0-9]{15,23})/members/([0-9]{15,23})/roles/([0-9]{15,23})$",
                re.IGNORECASE,
            ): "add_member_role",
            re.compile(
                r"/channels/([0-9]{15,23})/permissions/([0-9]{15,23})$", re.IGNORECASE
        ...
        "DELETE": {
            ...
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})/reactions/(.+)/([0-9]{15,23})$",
                re.IGNORECASE,
            ): "remove_reaction",
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})/reactions/(.+)/@me$",
            ...
            re.compile(
                r"/channels/([0-9]{15,23})/messages/([0-9]{15,23})/reactions/(.+)$",
                re.IGNORECASE,
            ): "clear_single_reaction",
            re.compile(r"/channels/([0-9]{15,23})$", re.IGNORECASE): "delete_channel",
            re.compile(
                r"/guilds/([0-9]{15,23})/emojis/([0-9]{15,23})$", re.IGNORECASE
            ): "delete_custom_emoji",
            re.compile(
                r"/guilds/([0-9]{15,23})/roles/([0-9]{15,23})$", re.IGNORECASE
            ): "delete_role",
            re.compile(
                r"/guilds/([0-9]{15,23})/members/([0-9]{15,23})/roles/([0-9]{15,23})$",
                re.IGNORECASE,
        ...
        "PATCH": {
            re.compile(
                r"/guilds/([0-9]{15,23})/members/@me/nick$", re.IGNORECASE
            ): "change_nickname",
            re.compile(
                r"/guilds/([0-9]{15,23})/members/([0-9]{15,23})$", re.IGNORECASE
            ): "edit_member",
            ...
            re.compile(
                r"/guilds/([0-9]{15,23})/roles$", re.IGNORECASE
            ): "move_role_position",
        },
    }
    WEBHOOK_EVENT_NAMES = {
        "POST": {
            re.compile(
                r"/webhooks/([0-9]{16,23})/([a-zA-Z0-9\-_]+?)$", re.IGNORECASE
            ): "send_webhook_message",
            re.compile(
                r"/webhooks/([0-9]{16,23})/([a-zA-Z0-9\-_]+?)/messages/([0-9]{16,23})$",
                re.IGNORECASE,
    ...
    MESSAGE_DECONSTRUCTOR = re.compile(
        r"^(?P<method>.+) https://discord(:?app)?.(?:com|gg)/api/v\d(?P<endpoint>.+) with (?P<payload>.+) has returned (?P<status>\d+)$"
    )
    WEBHOOK_MESSAGE_DECONSTRUCTOR = re.compile(
        r"^Webhook ID (?P<webhookid>.+) with (?P<method>.+) https://discord(:?app)?.(?:com|gg)/api/v\d(?P<endpoint>.+) has returned status code (?P<status>\d+)$"
    )
    ...
    @classmethod
    def get_http_event_name(
        cls, increment: str, method: str, url: str
    ) -> typing.Optional[str]:
        """
    ...
    async def log_message_increment(self, increment, match):
        ...
        event_name = self.get_http_event_name(
            increment, match.group("method"), match.group("endpoint")
        )
        ...
        async with self.bot.stats() as stats:
            stats.increment(
                ...
                tags={
                    ...
                    "status_code_class": match.group("status")[0]
                    + "x" * (len(match.group("status")) - 1),
                },
            )
